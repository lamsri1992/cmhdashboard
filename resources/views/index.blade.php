    ...
    <div class="col-md-12">
        <table>
            <tr class="text-center">
                <td>
                    <img src="https://cmbis.chiangmaihealth.go.th/web/img/chiangmaihealth.ico" width="70%">
                </td>
                <td style="padding-top: 3%;">
                    <h2>Chiangmai Data Dashboard System (CM-DDS)</h2>
                    <p class="text-secondary text-left">&nbsp;ระบบรายงานข้อมูล สาธารณสุขจังหวัดเชียงใหม่</p>
                </td>
            </tr>
        </table>
    </div>
